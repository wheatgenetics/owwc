...
tipcols[,3][tipcols[,6] == 'L1'] = "blue"
tipcols[,3][tipcols[,6] == 'L2'] = "red"

# plotting tree
pdf("Fig.wcm_chr6D_cluster.tau.pdf", width = 10, height = 10)
...
legend(0, 80, lty=1, lwd=2, cex=0.75,
       legend = c('Lineage 1 (L1)', 'Lineage 2 (L2)', 'WCM Resistant', 'WCM Susceptible'),
       text.col = c("blue", "red", "purple", "grey70"), col = c("blue", "red", "purple", "grey70"))
dev.off()
...
tipcols[,3][tipcols[,6] == 'L1'] = "blue"
tipcols[,3][tipcols[,6] == 'L2'] = "red"
tipcols[,3][tipcols[,6] == 'W'] = "green2"

# plotting tree
pdf("Fig.wcm_chr6D_cluster.all.pdf", width = 10, height = 10)
plotnj(unrooted.tree=hc2, type='p',
       show.tip.label=T, lab4ut="axial", label.offset=0.2, cex=0.4,
       edge.color=edgecols[,3], edge.width=1, tip.color=tipcols[,3], rotate.tree=-20)
legend(0, 120, lty=1, lwd=2, cex=0.75,
       legend = c('Lineage 1 (L1)', 'Lineage 2 (L2)', 'Wheat (W)' ,'WCM Resistant', 'WCM Susceptible'),
       text.col = c("blue", "red", "green2", "purple", "grey70"), col = c("blue", "red", "green2", "purple", "grey70"))
dev.off()
